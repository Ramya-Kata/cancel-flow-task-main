...
export default function ReasonOther({ onAction, state, setState }: Props) {
  const [touched, setTouched] = useState(false);
  const value: string = state?.other_feedback ?? '';

  const setValue = (v: string) =>
    setState((s: any) => ({ ...s, other_feedback: v }));
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:order-1 lg:col-span-6">
          ...
          <label className="mt-4 block text-sm md:text-base text-gray-900">
            What would have helped you the most?<sup className="text-gray-400">*</sup>
          </label>
